...
pub struct VerifiableCredential {
    ...
    #[serde(rename = "name", skip_serializing_if = "super::is_none_or_empty")]
    name: Option<String>,

    #[serde(rename = "description", skip_serializing_if = "super::is_none_or_empty")]
    description: Option<String>,

    #[serde(rename = "issuer")]
    issuer: Id,

    #[serde(rename = "validFrom", skip_serializing_if = "super::is_zero")]
    valid_from: u64,

    #[serde(rename = "validUntil", skip_serializing_if = "super::is_zero")]
    valid_until: u64,
